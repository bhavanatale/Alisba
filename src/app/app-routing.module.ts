...
const routes: Routes = [
  ...
  {
    path: 'dashboard',
    loadChildren: () => import('./vendor/dashboard/dashboard.module').then( m => m.DashboardPageModule)
  },
  ...
  {
    path: 'vendor-signup',
    loadChildren: () => import('./vendor/vendor-signup/vendor-signup.module').then( m => m.VendorSignupPageModule)
  },
  {
    path: 'vendor-signin',
    loadChildren: () => import('./vendor/vendor-signin/vendor-signin.module').then( m => m.VendorSigninPageModule)
  },
  {
    path: 'history',
    loadChildren: () => import('./vendor/history/history.module').then( m => m.HistoryPageModule)
  }
];
@NgModule({
  imports: [
